...
# Board
CONFIG_BOARD_TH1520_FPGA_C910_ARRAY:=light_fpga_fm_c910 light-fm-fpga
CONFIG_BOARD_TH1520_ARRAY:=light-fm light-% th1520-%

ifneq ($(filter $(CONFIG_BOARD_TH1520_FPGA_C910_ARRAY),$(BOARD_NAME)),)
  TARGET_NPU="IMG-AX3386"
  TARGE_CFG=CONFIG_VHA_XUANTIE_TH1520_FPGA_C910=y
else
  ifneq ($(filter $(CONFIG_BOARD_TH1520_ARRAY),$(BOARD_NAME)),)
    TARGET_NPU="IMG-AX3386"
    TARGE_CFG=CONFIG_VHA_XUANTIE_TH1520=y
  else
